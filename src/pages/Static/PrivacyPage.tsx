      ...
      <article className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-6">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            OUCloud 提供的各类工具（如颜色选取、Favicon
            图片裁剪、人民币大写转换等）均通过现代浏览器端技术（Canvas / Web API / 本地
            JavaScript）在您的本地设备上执行。我们不会将您的原始图片、财务金额或文本内容上传至任何远程服务器或第三方云端。
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            OUCloud 仅可能使用浏览器本地 LocalStorage
            存储必要的用户使用偏好设置（如深浅色模式切换、历史色板预设等），绝不用于跨站点追踪。
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            与绝大多数互联网网站一致，CDN 与托管边缘网络会自动记录常规的匿名 HTTP 请求日志（如 IP
